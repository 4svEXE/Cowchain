...
import Button from "../../shared/components/primotyButton/primotyButton";
import CustomCounter from "../../shared/components/customCounter/CustomCounter";
...
export default function Cowchain() {
  ...
  return (
    <div className="relative bg-opacity-25 Cowchain1 bg-white-40 flex flex-col text-black content-center items-center justify-center dark:text-white">
      ...
      <div className="container grid md:grid-cols-3 sm:grid-cols-1">
        <CustomCounter text={t([`homepage.technologies`])} count="15" />
